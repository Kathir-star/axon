...
export default function AccessControl() {
  ...
  // Simulated states for advanced security features
          ...
          <GlassCard>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between p-4 bg-white/5 border border-white/5 rounded-xl hover:bg-white/10 transition-colors">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-slate-800 border border-brand-blue/30 flex items-center justify-center font-bold text-brand-blue text-sm">
                    SK
                  </div>
                  <div>
                    <h5 className="font-bold text-sm text-white">Dr. Sarah Kapoor</h5>
                ...
                <Button variant="outline" size="sm" className="text-xs h-8 border-red-500/30 text-red-400 hover:bg-red-500/10 transition-colors">Revoke</Button>
              </div>

               <div className="flex items-center justify-between p-4 bg-white/5 border border-white/5 rounded-xl opacity-75">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-slate-800 border border-slate-600 flex items-center justify-center font-bold text-slate-400 text-sm">
                    MR
                  </div>
                  <div>
                    <h5 className="font-bold text-sm text-white">Dr. Marcus Reed</h5>
                    <p className="text-[10px] uppercase tracking-widest text-slate-500 flex items-center gap-1 mt-1 font-semibold">
            ...
            <div className="mt-6 pt-6 border-t border-white/5">
              <div className="flex items-center justify-between mb-4">
                ...
                <Badge variant="outline" className="border-amber-500/30 text-amber-400 bg-amber-500/5 px-2 py-0.5 text-[10px]">1 New</Badge>
              </div>
              <div className="flex items-center justify-between p-4 bg-amber-500/5 border border-amber-500/20 rounded-xl">
                 <div>
                    <h5 className="font-bold text-sm text-white">City Hospital Cardiology</h5>
                    <p className="text-xs text-slate-400 mt-1 hidden sm:block">Requesting 24h access</p>
                  </div>
                  <div className="flex gap-2">
                    <Button variant="outline" size="sm" className="text-xs h-8 border-white/10 hover:bg-white/5 text-slate-300 transition-colors">Deny</Button>
                    <Button size="sm" className="text-xs h-8 bg-amber-500/20 text-amber-500 border border-amber-500/50 hover:bg-amber-500/30 transition-colors">Approve</Button>
                  </div>
              </div>
            </div>
          </GlassCard>
          ...
          <GlassCard className="border-emerald-500/20 bg-slate-950 shadow-inner">
            ...
            <div className="py-4 border-t border-white/5 space-y-3">
              <div className="flex items-center justify-between text-xs font-mono bg-white/5 p-3 rounded-lg border border-white/5">
                <span className="text-slate-500">LAST_ACCESS</span>
                <span className="text-slate-300 font-semibold">Dr. Sarah Kapoor (10m ago)</span>
              </div>
              <div className="flex items-center justify-between text-xs font-mono bg-white/5 p-3 rounded-lg border border-white/5">
                <span className="text-slate-500">ACTIVE_STREAMS</span>
